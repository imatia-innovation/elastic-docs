...
const config: Config = {
  ...
  tagline: 'Documentación profesional del ERP Elastic Business - Guías completas, integrales y organizadas por módulo funcional',
  ...
  organizationName: 'imatia',
  projectName: 'wiki-elastic-business',
